...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "rajnithish27@gmail.com",
    href: "mailto:rajnithish27@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/nithish-kumar",
    content: "/nithish-kumar",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/nithishkumar",
    content: "/nithishkumar",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Nithish Kumar</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I'm Nithish Kumar, a Computer Science Engineer who
              graduated in 2024 with 1 year of experience in Full Stack
              Development, DevOps, and Database Management. I specialize in
              creating innovative solutions using modern technologies like
              Three.js, RAG, Agents, and Generative AI. My expertise spans
              across JavaScript, Next.js, React.js, WebSocket, MongoDB, MySQL,
              and more.
            </p>
            <p className="mb-10">
              I'm passionate about building scalable applications and automating
              workflows. When I'm not coding, you can find me exploring new
              technologies, contributing to open-source projects, or learning
              about the latest advancements in AI and web development.
            </p>
